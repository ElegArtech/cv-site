...
doc/                    documents de travail, non indexés :
                        graphe-navigation-noeuds.md — spécification des nœuds
                        prototype-graphe.html — prototype d'origine
...
`TRANSVERSALES`. Elles reprennent `doc/graphe-navigation-noeuds.md`, qui reste la
référence. Pour ajouter un objet, ajouter le nœud, puis la fiche correspondante
...
Aucun dépôt distant n'est configuré. Avant de publier, vérifier que `CNAME`
correspond bien au domaine visé.
